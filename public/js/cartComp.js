Vue.component('basket',
    {
        ...
        template: `
                    <div class="shopping-cart">
                        ...
                        <div id="cart-product">
                            <div class="cart-products"  v-for="product in basket.contents">
                        ...
                        <div id="total">
                        <span>Всего выбрано: {{basket.countGoods}}</span>
                        <br/>
                        <span>Сумма товаров: {{basket.amount}}</span>
                        </div>

                        <div class="cart-buttons">
                            <input class="btn modal-btn clean" type="button" value="Очистить корзину"
                                   @click="clearBasket()" :disabled="basket.length < 1">
                            <input class="btn modal-btn checkout" type="button" value="Оформить заказ"
                                   @click="checkout()" :disabled="basket.length < 1">
                        </div>
